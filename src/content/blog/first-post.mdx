...
description: "We're going back to the past!"
...
After much effort, I finalized creating a version of my blog
that is compatible with legacy browsers from the late 1990s.
That's more than a 30 year gap!
</div>
...
- **Windows**: it technically supports even **Windows 3.x** thanks to being designed to work for IE5.5 in mind, but I haven't tested it out. Windows 9x and NT 4 work like a charm.
...
None of the browsers I've targeted this blog to won't work under the current version of HTTPS used by nearly all websites since a few years ago. This has forced me to host the blog in a place where HTTPS is not forced.
