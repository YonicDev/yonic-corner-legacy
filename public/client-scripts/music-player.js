...
function shouldRedirectToStaticObjectPage() {
    return swfobject.ua.mac || (swfobject.ua.win && swfobject.ua.ie);
}*/

if(isNotSupported()) {
    document.getElementById("flashContent").innerHTML = "<p>The music player is disabled for Flash Player 7 for Mac due to major issues.</p><p>To activate the music player, use Flash Player 6 instead.</p>"
} else {// if (shouldRedirectToStaticObjectPage()) {
