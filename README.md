...
The music player relies on Flash Player. Versions 6, 8 and higher are supported. Flash Player 7 is not as it may cause crashes.
...
* **Music content will only use the first HTTP *(not HTTPS)* audio source in the `srcset`** field.
