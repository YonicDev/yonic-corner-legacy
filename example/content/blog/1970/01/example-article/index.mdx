...
Since 1.3.0, Anything within the `<div class="feed-preview">` element will be displayed in the partial feed. **It also includes all the innerHTML, so be careful.**
...
...That was a weird caption. For images with no captions, just don't write anything inside the caption element.
...
It supports syntax highlighting and you can copy code from it. Also, you can set a **filename header** to the code block in two ways:
